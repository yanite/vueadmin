      ...
      const filter = (f) => {
        if (typeof (f.component) === 'string') {
          if (f.component === 'layout/Layout') {
            f.component = 'layouts/PageView.vue'
          }
          try {
            console.log('load route f.compont ', f.compont)
            f.component = import(f.compont)
          } catch (error) {
            console.log('load route f.compont error ', f.compont)
            f.component = import('layouts/BlankView.vue')
          }
        }
      }
