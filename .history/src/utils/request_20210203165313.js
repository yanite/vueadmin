 ...
 * @returns {Promise}
 */
service.get = function get(url, params = {}) {
...
//  * @returns {Promise}
//  */
service.post = function post(url, data = {}) {
  return new Promise((resolve, reject) => {
...
service.getBinary = function getBinary(url, params = {}) {
  return new Promise((resolve, reject) => {
    axios.get(process.env.VUE_APP_SERVER_API + url, {
      params: params,
      headers: {
...
service.getBinaryByPost = function getBinaryByPost(url, data) {
  return new Promise((resolve, reject) => {
...
service.uploadFile = function post(url, data = {}) {
  return new Promise((resolve, reject) => {
    axios.post(process.env.VUE_APP_SERVER_API + url, data,
      {
        headers: {
...
async function get( url, params, config ) {
  return axios.get(url, params, Object.assign(axiosConfig, config))
}
