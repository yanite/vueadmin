...
function loadRoutes(routesConfig) {
  ...
  arguments[ 0 ].filter((e, i) => { e.path = 'views' + i })
  rootRoute.children = deepMergeRoutes(rootRoute.children, arguments[ 0 ])
  // rootRoute.children = arguments[0]
  const menuRoutes = rootRoute && rootRoute.children
  if (menuRoutes) {
    store.commit('setting/setMenuData', menuRoutes)
  } else {
    console.log(`no menu ${rootRoute}`)
  }
}
